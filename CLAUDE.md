...
Use `/release patch|minor|major` — it runs commit → push → annotated tag and
watches the builds. See `.claude/commands/release.md` for the conventions and
the known credential failures.
